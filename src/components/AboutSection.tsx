...
export function AboutSection() {
  return (
    <section id="about" className="min-h-screen flex flex-col justify-center items-center relative px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] overflow-hidden">
      ...
      <div className="flex flex-col items-center z-10 w-full max-w-4xl mx-auto gap-10 sm:gap-14 md:gap-16">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 w-full">
          <AnimatedText 
            ...
            className="font-medium leading-relaxed max-w-[560px] text-[clamp(1rem,2vw,1.35rem)] text-center"
          />
